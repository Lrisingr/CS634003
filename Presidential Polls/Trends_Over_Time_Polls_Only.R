...
ggplot2::labs(title = "Cumulative Mean Vote Percentage by RAW_POLL \n",  
              y = "Cumulative Percent Vote by POLLS-ONLY type", 
              x = "Poll Date", 
              color = "Candidate", 
              size="Calculated Weight")
         
#Calculate Cumulative mean & weighted mean for ADJ POLL and append the columns to the new Combine.IndivData dataframe
